...
const Home = ({unfilteredTasks, selectedProjectId, selectedDepartmentId}) => {
  ...
  return (
    <div className='home'>
        ...
        <div className="box box1"><ProgressCard departmentName={"Software"} departmentId={1} unfilteredTasks={unfilteredTasks}/></div>
        <div className="box box2"><ProgressCard departmentName={"Electrical"} departmentId={2} unfilteredTasks={unfilteredTasks}/></div>
        <div className="box box3"><ProgressCard departmentName={"Mechanical"} departmentId={3} unfilteredTasks={unfilteredTasks}/></div>
        <div className="box box4"><ProgressCard departmentName={"Safety"} departmentId={4} unfilteredTasks={unfilteredTasks}/></div>
        ...
        <div className="box box12"><UpcomingTask departmentName={"Safety"} departmentId={4} unfilteredTasks={unfilteredTasks}/></div>
        ...
        <div className="box box13"><EventsTable departmentName={"Safety"}/></div>
